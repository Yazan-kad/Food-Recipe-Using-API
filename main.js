const sreachBtn = document.getElementById("search-btn");
...
function getMealList() {
  let searchInputTxt = document.getElementById("sreach-input").value.trim();
  fetch(
...
function mealRecipeModel(meal) {
    ...
    let html = `
        ...
        <div class="recipe-link">
            <a href="${meal.strYoutube}" target="_blank">Watch Viedo</a>
        </div>
    `
